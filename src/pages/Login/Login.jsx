    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (authService.accessCheck(user, ['admin'])) {
                navigate('/dashboard'); //galing sa app.jsx, route for admin dashboard
                return;
            }

            setErrors((prev) => ({ ...prev, general: 'Access denied. Only staff can log in here.' }));
        } catch (error) {
    ...
    return (
        <div className="login-page">
            ...
            <main className="login-card" aria-label="Staff login">
                ...
                {errors.form && (
                    ...
                    >
                        ...
                        <span>
                            {errors.form}
                            {isLocked && lockTimer > 0 && <strong> Retry in {lockTimer}s.</strong>}
                        </span>
                    </div>
                )}
                ...
                <div className="login-notice" role="note">
                    <p>Authorized personnel only. Access is monitored and recorded for security purposes.</p>
                </div>

                <div className="login-role-switch">
                    <button type="button" className="role-switch-btn" onClick={() => navigate('/') }>
                        <User size={14} />
                        Login as User
                    </button>
                </div>
            ...
            <footer className="login-footer">
                <p> 2025 City Health Office 3. All rights reserved.</p>
            </footer>
        </div>
    );
}

...
════════════════════════════ */
const SUMMARY_STATS = [
    { label: 'Total Newborns This Month', value: 35, color: 'blue', icon: Baby },
    { label: 'Low Birth Weight (<2.5kg)', value: 4, color: 'orange', icon: Scale },
    { label: 'High-Risk Newborns', value: 3, color: 'rose', icon: AlertCircle },
    { label: 'Vaccinations Due', value: 12, color: 'yellow', icon: Syringe },
    { label: 'Missed Follow-ups', value: 2, color: 'purple', icon: XCircle },
];

const NEWBORNS = [
    {
        id: 'NB-001', babyName: 'Baby Reyes (Elena)', motherId: 'PT-2401', motherName: 'Maria Reyes',
        birthDate: '2026-02-26', gender: 'Female', birthWeight: 3.1, length: 50,
        headCirc: 33, gestationalAge: '38w 2d', deliveryType: 'NSD',
        riskLevel: 'Normal', vaccStatus: 'Pending', suppStatus: 'Ongoing',
        lastCheckup: '2026-02-28', nextAppt: '2026-03-15', barangay: 'Brgy. 3',
        condition: 'Healthy', notes: '',
        growthLog: [
            { date: 'Feb 26', weight: 3.1, length: 50, headCirc: 33 },
            { date: 'Feb 28', weight: 3.15, length: 50.2, headCirc: 33.1 },
        ],
        vaccLog: [
            { vaccine: 'BCG', dose: '1st', date: '2026-02-27', nextDue: null, status: 'Completed' },
            { vaccine: 'Hepatitis B', dose: '1st', date: null, nextDue: '2026-03-26', status: 'Pending' },
            { vaccine: 'OPV', dose: '1st', date: null, nextDue: '2026-03-26', status: 'Pending' },
        ],
        suppLog: [
            { supp: 'Vitamin D', dose: '400 IU/day', start: '2026-02-27', end: '2026-08-27', status: 'Ongoing' },
        ],
        checkupLog: [
            { date: 'Feb 28', vitals: 'Weight 3.15kg, Temp 36.8°C', staff: 'Midwife Elena P.', notes: 'Breastfeeding well.' },
        ],
        alerts: [],
    },
    {
        id: 'NB-002', babyName: 'Baby Cruz (Marco)', motherId: 'PT-2402', motherName: 'Ana Cruz',
        birthDate: '2026-02-24', gender: 'Male', birthWeight: 2.8, length: 47,
        headCirc: 32, gestationalAge: '37w 0d', deliveryType: 'CS',
        riskLevel: 'Monitor', vaccStatus: 'Pending', suppStatus: 'Ongoing',
        lastCheckup: '2026-02-27', nextAppt: '2026-03-10', barangay: 'Brgy. 1',
        condition: 'Special Care', notes: 'In NICU observation.',
        growthLog: [
            { date: 'Feb 24', weight: 2.8, length: 47, headCirc: 32 },
            { date: 'Feb 27', weight: 2.82, length: 47.2, headCirc: 32.1 },
        ],
        vaccLog: [
            { vaccine: 'BCG', dose: '1st', date: null, nextDue: '2026-03-05', status: 'Pending' },
            { vaccine: 'Hepatitis B', dose: '1st', date: '2026-02-24', nextDue: null, status: 'Completed' },
        ],
        suppLog: [
            { supp: 'Vitamin D', dose: '400 IU/day', start: '2026-02-25', end: '2026-08-25', status: 'Ongoing' },
            { supp: 'Iron', dose: '2 mg/kg/day', start: '2026-02-25', end: '2026-08-25', status: 'Ongoing' },
        ],
        checkupLog: [
            { date: 'Feb 27', vitals: 'Weight 2.82kg, Temp 36.9°C', staff: 'Dr. Reyes (OB)', notes: 'NICU monitoring — improving.' },
        ],
        alerts: ['NICU admission — special care required'],
    },
    {
        id: 'NB-003', babyName: 'Baby Santos (Sofia)', motherId: 'PT-2403', motherName: 'Elena Santos',
        birthDate: '2026-02-20', gender: 'Female', birthWeight: 3.4, length: 51,
        headCirc: 34, gestationalAge: '39w 4d', deliveryType: 'NSD',
        riskLevel: 'Normal', vaccStatus: 'Completed', suppStatus: 'Ongoing',
        lastCheckup: '2026-02-25', nextAppt: '2026-03-20', barangay: 'Brgy. 5',
        condition: 'Healthy', notes: '',
        growthLog: [
            { date: 'Feb 20', weight: 3.4, length: 51, headCirc: 34 },
            { date: 'Feb 25', weight: 3.5, length: 51.5, headCirc: 34.2 },
        ],
        vaccLog: [
            { vaccine: 'BCG', dose: '1st', date: '2026-02-21', nextDue: null, status: 'Completed' },
            { vaccine: 'Hepatitis B', dose: '1st', date: '2026-02-21', nextDue: null, status: 'Completed' },
        ],
        suppLog: [
            { supp: 'Vitamin D', dose: '400 IU/day', start: '2026-02-21', end: '2026-08-21', status: 'Ongoing' },
        ],
        checkupLog: [
            { date: 'Feb 25', vitals: 'Weight 3.5kg, Temp 36.5°C', staff: 'Midwife Ana M.', notes: 'Healthy and gaining weight.' },
        ],
        alerts: [],
    },
    {
        id: 'NB-004', babyName: 'Baby Diaz (Ramon)', motherId: 'PT-2404', motherName: 'Rosa Diaz',
        birthDate: '2026-02-22', gender: 'Male', birthWeight: 2.4, length: 45,
        headCirc: 31, gestationalAge: '36w 5d', deliveryType: 'CS',
        riskLevel: 'High', vaccStatus: 'Overdue', suppStatus: 'Missed',
        lastCheckup: '2026-02-23', nextAppt: '2026-02-28', barangay: 'Brgy. 7',
        condition: 'NICU', notes: 'Preterm — low birth weight.',
        growthLog: [
            { date: 'Feb 22', weight: 2.4, length: 45, headCirc: 31 },
            { date: 'Feb 23', weight: 2.41, length: 45.1, headCirc: 31 },
        ],
        vaccLog: [
            { vaccine: 'BCG', dose: '1st', date: null, nextDue: '2026-02-25', status: 'Overdue' },
            { vaccine: 'Hepatitis B', dose: '1st', date: null, nextDue: '2026-02-25', status: 'Overdue' },
        ],
        suppLog: [
            { supp: 'Iron', dose: '4 mg/kg/day', start: '2026-02-22', end: '2026-08-22', status: 'Missed' },
            { supp: 'Vitamin D', dose: '800 IU/day', start: '2026-02-22', end: '2026-08-22', status: 'Missed' },
        ],
        checkupLog: [],
        alerts: ['Preterm birth (36w5d)', 'Low birth weight 2.4kg', 'BCG and HepB vaccines overdue', 'NICU — urgent follow-up required'],
    },
    {
        id: 'NB-005', babyName: 'Baby Gomez (Lily)', motherId: 'PT-2405', motherName: 'Clara Gomez',
        birthDate: '2026-02-18', gender: 'Female', birthWeight: 3.6, length: 52,
        headCirc: 35, gestationalAge: '40w 0d', deliveryType: 'NSD',
        riskLevel: 'Normal', vaccStatus: 'Completed', suppStatus: 'Ongoing',
        lastCheckup: '2026-02-25', nextAppt: '2026-03-18', barangay: 'Brgy. 2',
        condition: 'Healthy', notes: '',
        growthLog: [
            { date: 'Feb 18', weight: 3.6, length: 52, headCirc: 35 },
            { date: 'Feb 25', weight: 3.75, length: 52.5, headCirc: 35.3 },
        ],
        vaccLog: [
            { vaccine: 'BCG', dose: '1st', date: '2026-02-19', nextDue: null, status: 'Completed' },
            { vaccine: 'Hepatitis B', dose: '1st', date: '2026-02-19', nextDue: null, status: 'Completed' },
        ],
        suppLog: [
            { supp: 'Vitamin D', dose: '400 IU/day', start: '2026-02-19', end: '2026-08-19', status: 'Ongoing' },
        ],
        checkupLog: [
            { date: 'Feb 25', vitals: 'Weight 3.75kg, Temp 36.6°C', staff: 'Midwife Elena P.', notes: 'Excellent growth.' },
        ],
        alerts: [],
    },
];
...
const ALERTS = [
    { type: 'critical', text: 'Baby Diaz (NB-004) — Low birth weight, NICU, vaccines overdue', time: '2 days ago' },
    { type: 'critical', text: 'Baby Cruz (NB-002) — NICU observation, BCG pending', time: '3 days ago' },
    { type: 'warning',  text: '12 newborns have vaccinations due within 7 days', time: 'Today' },
    { type: 'info',     text: '2 newborns missed scheduled follow-up appointments', time: 'Yesterday' },
];
        ...
        <div className="nb-page">
            ...
            <div className="nb-stats-grid">
                {SUMMARY_STATS.map(s => {
                    const Icon = s.icon;
                    return (
                        <div key={s.label} className={`nb-stat-card nb-stat--${s.color}`}>
                            <div className={`nb-stat-icon nb-icon--${s.color}`}><Icon size={20} /></div>
